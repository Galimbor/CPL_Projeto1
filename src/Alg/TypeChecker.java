...
//        }
    ...
    public void exitFunction_normal(Projeto.Function_normalContext ctx) {
        ...
        this.currentFunction.hasReturn = false;
        this.currentFunction = null;
        currentScope = currentScope.getParentScope();
    }
...
//                    this.validated = false;
//                    System.err.println("The return needs to be the last instruction in the central block at line: " + lastInsOrVar.start.getLine());
//                }
//            } else {
//                this.validated = false;
//                System.err.println("The return needs to be the last instruction in the central block at line: " + lastInsOrVar.start.getLine());
...
//            }
    ...
    public void exitDeclAndAtrib(Projeto.DeclAndAtribContext ctx) {
        ...
        if (expression == Symbol.PType.NULL)        //TODO make it prettier
        {
